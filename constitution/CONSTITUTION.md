# tool-sequential-png-preview Constitution

この文書は、tool-sequential-png-preview の開発組織における最上位 contract です。
...
tool-sequential-png-preview の開発組織の目的は current procedure への服従ではありません。
