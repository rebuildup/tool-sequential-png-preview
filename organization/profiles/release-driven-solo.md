...
tool-sequential-png-preview の current release-driven development で使用する Operating Model を定義します。
...
- Sequential image decoding/rendering behavior must be verified in browser/host context when UI behavior changes.
